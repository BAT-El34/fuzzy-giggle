...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const instanceRaw = await geny(`/v1/instances/${uuid}`,{},req);
    const tokenPayload = await geny('/v1/instances/access-token',{method:'POST',body:{instance_uuid:uuid}},req);
    ...
    return json(res,200,{ok:true,authMode:auth.mode,instance,accessToken,expires:'provider-managed'});
