...
if (ROOT / "app/src/main/java/com/draftwa/mobile/DraftOverlayController.java").exists() and "0.8.5" in build_path.read_text(encoding="utf-8"):
    print("DraftWA 0.8.5 overlay patch already applied")
    raise SystemExit(0)

overlay = r'''package com.draftwa.mobile;
...
'''
(ROOT / "app/src/main/java/com/draftwa/mobile/DraftOverlayController.java").write_text(overlay, encoding="utf-8")

p = ROOT / "app/src/main/java/com/draftwa/mobile/Prefs.java"
